...
Pooling works great in the two-sample t-test scenario, because it reduces the variance of each observation from $\sigma^2$ to $\sigma^2/g$, where $g$ is the pool size.
