...
#' and \code{FALSE} otherwise. Also works for multiple values and sets of
#' endpoints.
#'
...
#' included.
#' @param include.lower,include.upper Logical value indicating whether the lower
#' (upper) endpoint should be included.
#'
